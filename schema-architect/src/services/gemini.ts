    ...
    config: {
      ...
      responseSchema: {
        ...
        properties: {
          ...
          verificationLog: { type: Type.STRING, description: "Detailed verification log containing the mandatory ### Schema Blueprint pre-flight verification, listing each @type to be used, its direct schema.org link, and a one-sentence validity verification for every property assigned." },
          gscAnalysis: {
            type: Type.ARRAY,
            items: {
              type: Type.OBJECT,
